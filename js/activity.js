...
function getTourList() {
  axios.get("https://ptx.transportdata.tw/MOTC/v2/Tourism/Activity?%24top=30&%24format=JSON", {
      ...
      thisData.forEach(function (item) {
        ...
        str += `
                <article class="col-12 col-md-6 tm-post">
                      ...
                      <a href="activity-page.html?id=${item.ActivityID}" class="effect-lily tm-post-link tm-pt-60">
                          ...
                          <h2 class="tm-pt-30 tm-color-primary tm-post-title">${item.ActivityName}</h2>
                      </a>                    
                      <p class="tm-pt-30">`
          + sliceDesStr + `<span>．．．</span>` +
          `<a href="activity-page.html?id=${item.ActivityID}" class ="moreBtn">
                       more</a>`+
          `</p>
...
sendBtn.addEventListener('click', function (e) {
  ...
  axios.get(
    `https://ptx.transportdata.tw/MOTC/v2/Tourism/Activity/${city}?$filter=contains(ActivityName,'${keywords}')&$format=JSON`,
    {
      headers: getAuthorizationHeader()
    })
    .then(function (response) {
